  ...
  return (
    <div className="mx-auto max-w-md px-4 py-16">
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-4">
        <div>
          ...
          <input
            ...
            className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm focus:border-sharp-500 focus:outline-none"
          />
        </div>
        <div>
      ...
      <button
        ...
        className="mt-4 text-sm text-sharp-600 hover:underline"
      >
